...
#SBATCH --array=1-12
#SBATCH --mem=30GB
#SBATCH --job-name=deep_eval
#SBATCH --output=/scratch/cg3306/climate/CM2P6Param/slurm_logs/deep_eval_%a_%A.out
#SBATCH --error=/scratch/cg3306/climate/CM2P6Param/slurm_logs/deep_eval_%a_%A.err
